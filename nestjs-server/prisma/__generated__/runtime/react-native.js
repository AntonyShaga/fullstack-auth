...
var wi = ge(Xe => {
	...
	function Ca(e) {
		...
		if (e.length !== void 0)
			return typeof e.length != 'number' || en(e.length) ? ke(0) : Hr(e)
...
var _i,
	...
	pn = Fe(() => {
		...
		;(_i = '/'),
			(xl = { sep: _i }),
			(Pl = { resolve: bl, posix: xl, join: El, sep: _i }),
			(we = Pl)
	})
var Ii = ge((_f, vl) => {
	vl.exports = {
...
var hn = ge((Xm, Gi) => {
	...
	f()
	var _l = Ji()
	Gi.exports = e => (typeof e == 'string' ? e.replace(_l(), '') : e)
})
var Wi = ge((yg, sr) => {
	'use strict'
	m()
		...
		let t = new nn(),
			...
			n = {
				...
				transactionContext: async (...i) =>
					(await r(...i)).map(s => Ga(t, s))
			}
		return (
			e.getConnectionInfo &&
				(n.getConnectionInfo = Ka(t, e.getConnectionInfo.bind(e))),
			n
		)
	},
	Ga = (e, t) => {
...
var Ai = {
	enabled:
		!Pi && vi == null && Ti !== 'dumb' && ((sn != null && sn !== '0') || Ci)
}
function V(e, t) {
...
function gn(e, ...t) {
	Vi.warn() && console.warn(`${It.warn} ${e}`, ...t)
}
function Sl(e, ...t) {
...
R.toNearest = function (e, t) {
	...
	return (
		e.d[0]
			? ((F = !1), (r = U(r, e, 0, t, 1).times(e)), (F = !0), k(r))
			: ((e.s = r.s), (r = e)),
		r
	)
}
...
R.toPower = R.pow = function (e) {
	...
	if (((t = ee(e.e / I)), t >= e.d.length - 1 && (r = u < 0 ? -u : u) <= Ll))
...
function De(e, t) {
	...
	if (
		...
		return (
			(u = pr(M, g + 2, _).times(o + '')),
			(A = De(new M(n + '.' + r.slice(1)), g - C).plus(u)),
			(M.precision = _),
			t == null ? k(A, _, L, (F = !0)) : A
		)
	for (
		h = A,
			l = s = A = U(A.minus(1), A.plus(1), g, 1),
			v = k(A.times(A), g, 1),
			i = 3;
		;
		...
		if (
			...
			if (
				((l = l.times(2)),
				o !== 0 && (l = l.plus(pr(M, g + 2, _).times(o + ''))),
				(l = U(l, new M(S), g, 1)),
				t == null)
			)
				if (Lt(l.d, g - C, L, a))
					(M.precision = g += C),
						...
						(v = k(A.times(A), g, 1)),
						(i = a = 1)
				else return k(l, (M.precision = _), L, (F = !0))
			else return (M.precision = _), l
		;(l = u), (i += 2)
	}
}
function ao(e) {
...
function Kl(e, t) {
	...
	return (
		!e.s || !t.s
			? (r = new this(NaN))
			: !e.d && !t.d
				? ((r = be(this, o, 1).times(t.s > 0 ? 0.25 : 0.75)),
					(r.s = e.s))
				: !t.d || e.isZero()
					? ((r = t.s < 0 ? be(this, n, i) : new this(0)),
						(r.s = e.s))
					: !e.d || t.isZero()
...
function uo(e) {
	...
	function i(o) {
		...
		if (l === 'bigint')
			return (
				o < 0 ? ((o = -o), (u.s = -1)) : (u.s = 1), lr(u, o.toString())
			)
		throw Error($e + o)
	}
	if (
...
var Ru = e => e,
	...
	N = {
		...
		util: {
			...
			objId: function (e) {
				return (
					e.__id || Object.defineProperty(e, '__id', { value: ++Su }),
					e.__id
				)
			},
			...
			for (let A in r) {
				...
				for (let M = 0; M < O.length; ++M) {
					...
					for (
						...
						let He = new fe(A, _ ? N.tokenize(h, _) : h, Et, h, $)
						if (
							(Y.push(He),
							C && Y.push(C),
...
function Lu(e) {
	let t = Object.keys(_t.ModelAction).join('|'),
...
function zc(e, t) {
	let r = Te(t),
		n = Object.keys(_t.ModelAction).concat('count')
	return {
		getKeys() {
			return n
		},
...
\`\`\``
			: '',
		g = (0,
		Vn.default)(`Hi Prisma Team! My Prisma Client just crashed. This is the report:
## Versions
...
${a.backtrace}`,
	...
	buildQueryError(t) {
		if (t.user_facing_error.is_panic)
			return new ue(
				Gn(this, t.user_facing_error.message),
				this.config.clientVersion
			)
		let r = this.getExternalAdapterError(t.user_facing_error)
		return r
			? r.error
			: Dr(t, this.config.clientVersion, this.config.activeProvider)
	}
...
function la(e, t) {
	return Ip(e) ? [new se(e, t), Vs] : [e, Qs]
}
function Ip(e) {
