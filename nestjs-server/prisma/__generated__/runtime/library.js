		...
		let t = new Wn(),
			...
			n = {
				...
				transactionContext: async (...i) =>
					(await r(...i)).map(s => yu(t, s))
			}
		return (
			e.getConnectionInfo &&
				(n.getConnectionInfo = Eu(t, e.getConnectionInfo.bind(e))),
			n
		)
	},
	yu = (e, t) => {
...
var _o = {
	enabled:
		!Ao && Io == null && Oo !== 'dumb' && ((Kn != null && Kn !== '0') || ko)
}
function $(e, t) {
	...
	xe = (e, t, r) => {
		...
		if (ei(e)) {
			...
			if (Array.isArray(e)) {
				...
				return (
					e.length === t.length && e.every((s, a) => xe(s, t[a], r))
				)
			}
...
var Ue = e =>
	...
	we = e =>
		Object.assign(me(e), {
			between: (t, r) =>
				we(j(e, ((n, i) => I(o => Ee(o) && n <= o && i >= o))(t, r))),
	...
	Ge = e =>
		Object.assign(me(e), {
			between: (t, r) =>
				Ge(j(e, ((n, i) => I(o => Be(o) && n <= o && i >= o))(t, r))),
...
var ni = class e {
	...
	when(t, r) {
		...
		return new e(
			this.input,
			n ? { matched: !0, value: r(this.input, this.input) } : ri
		)
	}
	otherwise(t) {
...
async function Zu(e) {
	...
	if (
		(n || (n = await Vo(['/lib64', '/usr/lib64', '/lib', '/usr/lib'])), n)
	) {
...
m.inverseTangent = m.atan = function () {
	...
	if (u.isFinite()) {
		...
		if (u.abs().eq(1) && p + 4 <= Fi)
			return (s = Pe(c, p + 4, d).times(0.25)), (s.s = u.s), s
	} else {
...
m.minus = m.sub = function (e) {
	...
	if (
		((r = re(e.e / b)), (c = re(f.e / b)), (u = u.slice()), (o = c - r), o)
	) {
		for (
			p = o < 0,
				p
...
m.plus = m.add = function (e) {
	...
	if (
		((o = re(p.e / b)), (n = re(e.e / b)), (u = u.slice()), (i = o - n), i)
	) {
		for (
			i < 0
				? ((r = u), (i = -i), (s = c.length))
...
m.precision = m.sd = function (e) {
	...
	return (
		r.d ? ((t = $s(r.d)), e && r.e + 1 > t && (t = r.e + 1)) : (t = NaN), t
	)
}
m.round = function () {
	var e = this,
...
m.times = m.mul = function (e) {
	...
	return (
		...
		(e.d = o),
		(e.e = an(o, r)),
		E ? y(e, p.precision, p.rounding) : e
	)
}
...
m.toNearest = function (e, t) {
	...
	return (
		e.d[0]
			? ((E = !1), (r = M(r, e, 0, t, 1).times(e)), (E = !0), y(r))
			: ((e.s = r.s), (r = e)),
		r
	)
}
...
function Mi(e, t) {
	...
	for (
		t == null ? ((E = !1), (l = g)) : (l = t), a = new d(0.03125);
		e.e > -2;
...
function rp(e, t) {
	...
	return (
		!e.s || !t.s
			? (r = new this(NaN))
			: !e.d && !t.d
				? ((r = Pe(this, o, 1).times(t.s > 0 ? 0.25 : 0.75)),
					(r.s = e.s))
				: !t.d || e.isZero()
					? ((r = t.s < 0 ? Pe(this, n, i) : new this(0)),
						(r.s = e.s))
					: !e.d || t.isZero()
...
function Us(e) {
	...
	function i(o) {
		...
		if (l === 'bigint')
			return (
				o < 0 ? ((o = -o), (u.s = -1)) : (u.s = 1), tn(u, o.toString())
			)
		throw Error(Ke + o)
	}
	if (
...
function Lt(e = {}) {
	...
	return Object.entries(t).reduce(
		(n, [i, o]) => (
			Da[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o), n
		),
		{ select: {} }
	)
}
...
var qa = e => (Array.isArray(e) ? e : e.split('.')),
	...
	Va = (e, t, r) =>
		qa(t).reduceRight(
			(n, i, o, s) => Object.assign({}, Xi(e, s.slice(0, o)), { [i]: n }),
			r
		)
function Zd(e, t) {
...
\`\`\``
			: '',
		c = (0,
		no.default)(`Hi Prisma Team! My Prisma Client just crashed. This is the report:
## Versions
...
function Sm(e) {
	...
	return (
		process.platform !== 'win32' &&
			(i =
				fo.default.constants.dlopen.RTLD_LAZY |
				fo.default.constants.dlopen.RTLD_DEEPBIND),
...
${a.backtrace}`,
	...
	buildQueryError(t) {
		if (t.user_facing_error.is_panic)
			return new ce(
				yo(this, t.user_facing_error.message),
				this.config.clientVersion
			)
	...
	class t {
		...
		_request(n) {
			...
			return this._tracingHelper.runInChildSpan(s.operation, () =>
				new ou.AsyncResource('prisma-client-request').runInAsyncScope(
					() => l(o)
				)
			)
		}
